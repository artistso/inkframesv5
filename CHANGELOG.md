...
- **First-launch Start overlay.** If no local recovery snapshot is restored, InkFrame now opens with a tablet-friendly template picker directly over the canvas, plus Blank canvas, Project manager, Skip, and Don’t show again actions.
