...
try{
  ...
  const html=readFileSync(generated,'utf8'),sourcePath=resolve(root,'web/feedback-report.js'),source=readFileSync(sourcePath,'utf8'),injector=readFileSync(resolve(root,'tools/inject-feedback-report.mjs'),'utf8'),rootInjector=readFileSync(resolve(root,'tools/inject-brush-v2-index.mjs'),'utf8'),gradle=readFileSync(resolve(root,'app/build.gradle.kts'),'utf8'),mainActivity=readFileSync(resolve(root,'app/src/main/kotlin/com/inkframe/studio/MainActivity.kt'),'utf8');
