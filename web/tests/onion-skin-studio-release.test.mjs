...
try{
  ...
  const html=readFileSync(generated,'utf8'),sourcePath=resolve(root,'web/onion-skin-studio.js'),source=readFileSync(sourcePath,'utf8'),injector=readFileSync(resolve(root,'tools/inject-onion-skin-studio.mjs'),'utf8');
