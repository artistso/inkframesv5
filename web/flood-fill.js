...
// This sibling module is the final external script before the app IIFE. Load
// velocity dynamics synchronously so it can wrap the canvas pointer listener
// before registration. jsdom skips this networkless parser-time load; the
// module is covered independently by its Node regression suite.
if (typeof document !== 'undefined' && typeof window !== 'undefined' &&
    document.readyState === 'loading' && !window.InkFrameBrushDynamics &&
